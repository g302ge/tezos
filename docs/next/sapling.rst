...
``src/proto_013_Pswf4gE3/lib_protocol/test/integration/michelson/contracts/sapling_contract.tz``.
...
::
   ...
   running src/proto_013_Pswf4gE3/lib_protocol/test/integration/michelson/contracts/sapling_contract.tz \
   --init '{ }' --burn-cap 3 &

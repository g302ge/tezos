...
-  ``big_map (k) (t)``: Lazily deserialized maps from keys of type
   ...
   See the section on :ref:`operations on big maps <OperationsOnBigMaps_next>` for a description of the syntax of values of type ``big_map (k) (t)`` and available operations.
...
The multisig commands of :ref:`Tezos command line client <client_manual_next>`
use this

...
The :ref:`randomness<random_seed_next>` is obtained from information already found on the
...
:ref:`protocol constant <protocol_constants_next>`.
...
The seed of the PRNG is the :ref:`random seed <random_seed_next>` associated with cycle ``n-PRESERVED_CYCLES``.
